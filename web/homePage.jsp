    ...
    <body>
                        ...
                        <div>
                            <div class="dropdown mt-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a class="dropdown-item" href="ViewRecharge">Lịch sử nạp tiền </a></li>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="withdrawModalLabel">Yêu cầu rút tiền</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="RequestToWithdraw" method="post">
                            ...
                            <div class="dropdown mt-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a class="dropdown-item" href="mySalesOrder">Đơn Mua Của Tôi </a></li>
                                </ul>
                            </div>
                            <div class="dropdown mt-3">
                                <button class="drop" class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown">
        ...
        <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
            <div class="hero-container" data-aos="fade-in">
                <h1>HomePage</h1>
                <p>Tôi Trung Gian Mọi Tài Khoản</p>
            </div>
        </section><!-- End Hero -->
