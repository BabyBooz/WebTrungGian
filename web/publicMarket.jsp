                    ...
                    <section>
                        <div class="container-xl" style="max-width: 100%;">
                            <div class="card-header" style="background-color: #E9ECEF ">
                                <h2 class="text-left" style="font-size: 30px;">Đơn Trung Gian Công Khai</h2>
                            </div>
                            ...
                            <div class="table-responsive" style="margin-bottom: 50px; overflow-x: scroll; overflow-y: visible;">
                                <table class="table table-striped table-bordered table-hover table-fixed text-nowrap">
                                    ...
                                    <form action="searchMarket" id="myForm">
                                        <tr style="background-color: #F8F9FA;">
                                            <td class="scope-detail"></td>
                                            <td><input name="name" type="text" class="form-control" id="input2"></td>
                                            <td><input  type="text" class="form-control" name="contact" id="input3"></td>
                                            <td class="scope-fee">
                                            ...
                                            <td class="scope-price">
                                                <select class="form-select" name="status_fee" id="mySelect" style="height: 38px; font-size: 15px;background-color: #F8F9FA;border: 1px solid #dee2e6;">
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><input type="text" class="form-control" name="created_by" id="input10"></td>
                                            <td>
                                                <div class="input-group" style="display: ruby;">
                                            ...
                                            <td><input name="id"  type="number" class="form-control" id="input1"></td>
                        ...
                        <div class="pagination">
                            <c:forEach begin="1" end="${endP}" var="i">
                                <a href="publicMarket?index=${i}">${i}</a>    
                            </c:forEach>
                        </div>
                    </section>
