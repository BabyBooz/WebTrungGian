...
public class Product1 {
    ...
    public Product1(int id, int created_by, String name, String image, Float price, int status_fee, String description, String contact, String hidden_content, int status_product, Date created_date, Date updated_date) {
        this.id = id;
    ...
    public Product1(int created_by, String name, String image, Float price, int status_fee, String description, String contact, String hidden_content, int status_product) {
        this.created_by = created_by;
        this.name = name;
        this.image = image;
        this.price = price;
    ...
    public Product1(int id, String name, Float price, int status_fee, String description, String contact, String hidden_content, int status_product) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.status_fee = status_fee;
