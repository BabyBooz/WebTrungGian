 ...
 * @author linhnghiem
 */
@WebServlet(name="ViewRecharge", urlPatterns={"/ViewRecharge"})
public class ViewRecharge extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewRecharge</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewRecharge at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            List<WithdrawDTO> withdrawDTOs = withdrawDAO.getWithdrawsByFilterUser2(withdrawFilter, account.getId());
