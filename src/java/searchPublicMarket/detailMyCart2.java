 ...
 * @author linhnghiem
 */
@WebServlet(name="detailMyCart2", urlPatterns={"/detailMyCart2"})
public class detailMyCart2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("detailMyCart2.jsp").forward(request, response);
        }else{
